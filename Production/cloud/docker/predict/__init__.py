...
def process_data(data,age_model,mood_model,detector,img_size=400):
    ...
    if len(rects) > 0:        
        ...
        for o,rect in enumerate(rects):                
            ...
            input_mood,input_age = preprocess_frame(roi)            
...
def getdata(type,fp_name):
    ...
    if type =='image/jpeg' :   
        ...
        return_data = process_data(data,age_model,mood_model,detector,img_size)
    ...
    # Input is a video
        ...
        while True:
            ...
            pred_data = process_data(data,age_model,mood_model,detector,img_size)
